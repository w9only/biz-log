...
import logapi.annotation.LogIgnore;
import logapi.annotation.LogAllFields;
import logapi.annotation.LogField;
...
public class DefaultDiffItemsToLogContentService implements IDiffItemsToLogContentService, BeanFactoryAware, SmartInitializingSingleton {
    ...
    public String toLogContent(DiffNode diffNode, final Object sourceObject, final Object targetObject) {
        ...
        LogAllFields annotation = sourceObject.getClass().getAnnotation(LogAllFields.class);
    ...
    private void generateAllFieldLog(Object sourceObject, Object targetObject, StringBuilder stringBuilder, DiffNode node,
                                     LogAllFields annotation, Set<DiffNode> set) {
        ...
        LogField diffLogFieldAnnotation = node.getFieldAnnotation(LogField.class);
    ...
    private String getFieldLogName(DiffNode node, LogField diffLogFieldAnnotation, boolean isField) {
    ...
    private String getParentFieldName(DiffNode node, boolean isField) {
        ...
        while (parent != null) {
            LogField diffLogFieldAnnotation = parent.getFieldAnnotation(LogField.class);
